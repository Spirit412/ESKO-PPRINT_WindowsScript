...
# getParamCUT = ConMySQL(CutTools).get()
# Zub = getParamCUT['zub']
# DPrint = getParamCUT['HPrint']
# Polimer = getParamCUT['HPolimer']
# Distorsia = rd((Polimer / DPrint) * 100, 4)  # вычисляем % дисторсии до 4го знака после. В старой версии % брался из БД
# # для полимера 1.7
# Polimer17 = getParamCUT['Hpolimer_17']
# Distorsia17 = rd((Polimer17 / DPrint) * 100,
#                  4)  # вычисляем % дисторсии до 4го знака после. В старой версии % брался из БД
# Vsheet = getParamCUT['Vsheet']
#
# HCountItem = getParamCUT['HCountItem']
# VCountItem = getParamCUT['VCountItem']
#
# # отступы
# HGap = getParamCUT['HGap']
# VGap = getParamCUT['VGap']
#
try:
...
print(' ОБЩЕЕ КОЛИЧЕСТВО ПОЛЕЙ ' + str(LenPole()))
PageX = int(3.5 * LenPole())
print(' Ширина страницы ' + str(PageX))
PageY = 3.5
print(' Высота страницы ' + str(PageY))
